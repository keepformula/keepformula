    ...
    <div class="row mobile-header-padding q-pt-sm">
      <div class="q-pa-xs q-mx-auto col-12 col-sm-10 col-xl-8 col-lg-8 col-md-10">
                      ...
                      <q-item class="q-pr-none" tag="label">
                        <q-item-main>
                          <div class="parent animate-scale" key="text">
                            ...
                            <div class="div2 relative-position"> {{ lengthConvert }} {{ outputUnit }}
                              <q-btn class="absolute-right q-my-md q-mr-sm"
                                     ...
                                     outline
                                     icon="file_copy"
                                     v-clipboard="() => this.lengthConvert">
                              </q-btn>
                            </div>
                          </div>
                        </q-item-main>
        ...
        <div class="col-12 col-md-12 col-lg-6 mobile-size-wiki-margin q-pl-lg">
          <blockquote class="embedly-card" data-card-controls="0"><h4><a v-bind:href=this.wiki>Unit of length</a></h4><p>{{ $t('length_wiki') }}</p></blockquote>
        </div>
        </div>
      </div>
    </div>
