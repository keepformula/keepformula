        ...
        <div class="row">
          ...
          <div>
            <p class="q-display-1 mobile-size-component-header">
              {{ $t('density_converter') }}
            <a
              href="https://en.m.wikipedia.org/wiki/Density"
              target="_blank"
              :title="$t('density_converter_wiki_icon')">
              <q-icon
                class="text-primary"
                name="help"
                />
                ...
                <q-card-main>
                  <div class="row q-mt-md">
                    <div class="col-8 col-md-8 col-sm-8 col-lg-6 col-xl-7 col-xs-12 q-mb-md q-pr-md" >
                      <q-input autofocus type="text" ref="input" v-model="value" :float-label="$t('value_label')"/>
                    </div>
