    ...
    <div class="row mobile-header-padding q-pt-sm">
      <div class="q-pa-xs q-mx-auto col-12 col-sm-10 col-xl-8 col-lg-8 col-md-10">
                      ...
                      <q-item-main>
                        <div class="parent animate-scale" key="text">
                          <div class="div1"> {{ value }} {{ inputUnit }} </div>
                            <div class="div2 relative-position"> {{ volumeConvert }} {{ outputUnit }}
                              <q-btn class="absolute-right q-my-md q-mr-sm"
                                     ...
                                     outline
                                     icon="file_copy"
                                     v-clipboard="() => this.volumeConvert">
                              </q-btn>
                            </div>
                        </div>
                      </q-item-main>
        ...
        <div class="col-12 col-md-12 col-lg-6 mobile-size-wiki-margin q-pl-lg">
          <blockquote class="embedly-card" data-card-controls="0"><h4><a v-bind:href=this.wiki>Unit of volume</a></h4><p>{{ $t('volume_wiki') }}</p></blockquote>
        </div>
        </div>
      </div>
    </div>
...
export default {
  ...
  data () {
    return {
      ...
      wiki: 'https://en.wikipedia.org/wiki/Unit_of_volume',
