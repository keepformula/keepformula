    ...
    <div class="row mobile-header-padding q-pt-sm">
      <div class="q-pa-xs q-mx-auto col-12 col-sm-10 col-xl-8 col-lg-8 col-md-10">
                        ...
                        <div class="parent animate-scale" key="text">
                          <q-list inset-separator class="q-mt-xs no-border-left-right">
                            <q-item>
                              ...
                              <q-item-main color="">
                                <span> {{ flowRateConvert }} {{ outputUnit }} </span>
                              </q-item-main>
                              <q-item-side right>
        ...
        <div class="col-12 col-md-12 col-lg-6 mobile-size-wiki-margin q-pl-lg desktop-only">
          <blockquote class="embedly-card" data-card-controls="0"><h4><a v-bind:href=this.wiki>Volumetric flow rate</a></h4><p>{{ $t('flow_rate_wiki') }}</p></blockquote>
        </div>
        </div>
      </div>
    </div>
